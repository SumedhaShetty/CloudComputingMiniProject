...
# mongodb+srv://Sumedha:<password>@cluster0.uta04.mongodb.net/myFirstDatabase?retryWrites=true&w=majority
# CCMiniProject
    client = MongoClient("mongodb+srv://Sumedha:CCMiniProject@cluster0.uta04.mongodb.net/"
                         "test?ssl=true&ssl_cert_reqs=CERT_NONE&retryWrites=true&w=majority")
